/*
  ...
  This example uses the LARA's mobile data connection to:
    ...
    * Push the RTCM data to an external u-blox GNSS module over I2C (not to the one built-in to the LARA-R610M8S)
...
void setup()
{
  ...
  // Start communication with the LARA-R6. Load and activate the Packet Switched Data profile.
...
void loop()
{
  ...
  myLARA.bufferedPoll(); // Process the LARA-R6 URC's. This pushes the incoming RTCM data to the GNSS.
