...
// Include SoftwareSerial.h _before_ including Firechip_u-blox_LARA-R6_Arduino_Library.h
// to allow the LARA-R6 library to detect SoftwareSerial.h using an #if __has_include
...
// Create a SoftwareSerial object to pass to the LARA-R6 library
// Note: we need to call laraSerial.begin and laraSerial.end in setup() - see below for details
SoftwareSerial laraSerial;
