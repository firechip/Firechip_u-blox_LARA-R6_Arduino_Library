...
#ifndef FIRECHIP_LARA_R6_ARDUINO_LIBRARY_H
#define FIRECHIP_LARA_R6_ARDUINO_LIBRARY_H
...
// _before_ the #include <Firechip_u-blox_LARA-R6_Arduino_Library.h>, for this to work.
...
public:
  ...
  LARA_R6_error_t setMQTTclientId(String clientId);
  LARA_R6_error_t setMQTTserver(String serverName, int port);
  ...
  LARA_R6_error_t subscribeMQTTtopic(int max_Qos, String topic);
  LARA_R6_error_t unsubscribeMQTTtopic(String topic);
...
#endif //FIRECHIP_LARA_R6_ARDUINO_LIBRARY_H
